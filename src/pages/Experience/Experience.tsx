    ...
    <div className={`experience-container${darkMode ? " dark-mode" : ""}`}>
      ...
      <div className="experience-item">
        <Card
          ...
          The technologies used were mainly ReactJS, JavaScript, Git, TypeScript, Unit Tests, Integration Tests, Cypress, GraphQL, CSS, HTML, Styled Components, NPM and Yarn, APIs, jQuery, Jenkins, JIRA, Figma, Responsive Design, Docker, internal processes and
      ...
      <div className="experience-item">
        <Card
          ...
          company="CESAM & INPA"
          description="Research Scientist (Biologist) with 10+ years of experience working on various projects in academic and research settings not related with the Tech industry, in different institutions and universities from different countries, specializing in research on the Amazon rainforest region. 
          Strong collaborator with a proven track record of working effectively in interdisciplinary teams.
          "
          startDate={new Date("2012-09-01")} school={""}        />
      </div>
      <div className="experience-item">
        <Card
          title="Communications, Image, and Public Relations"
          company="SCIRP - UA"
          description="Collaborator in the Communications, Image, and Public Relations Services of University of Aveiro working mainly in the Office of Access to Higher Education;
          UA Program in Schools and Teaching Fairs;
          Monitor of the 2010 and 2012 editions of Summer Academy;
          Digital enrollment of students placed in the 1st phase of access to Higher Education.
          "
          startDate={new Date("2009-01-01")} school={""}        />
      </div>
    </div>
  );
};
